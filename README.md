...
$chatWorkApi->me()->room()->messages()->post($content, $self_unread = FALSE);
...
$chatWorkApi->my()->room()->messages()->post($content, $self_unread = FALSE);
...
$chatWorkApi->room($room_id)->messages()->post($content, $self_unread = FALSE);
